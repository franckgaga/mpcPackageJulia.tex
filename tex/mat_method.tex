...
\cref{fig:control_topology} illustrates the main signals and the interactions between the different components of the controllers, in which the gray parts are features that are less commonly used, thus disabled by default. The following sections introduce the various mathematical symbols.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{fig/control_topology.pdf}
